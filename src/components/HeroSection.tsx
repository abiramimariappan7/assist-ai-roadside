...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-br from-white to-brand-light pt-32 pb-16 md:pt-40 md:pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col space-y-6 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-dark">
              Your Vehicle,<br />
              <span className="text-brand-blue">Our Mechanics</span>,<br />
              Anytime, Anywhere
            </h1>
          ...
          <div className="relative animate-fade-in animate-delay-200">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg z-20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">Mechanic Found!</p>
                  <p className="text-xs text-gray-500">ETA: 12 minutes</p>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-4 -left-4 md:-left-10 bg-brand-orange rounded-full h-24 w-24 flex items-center justify-center shadow-lg">
            ...
            <div className="absolute -z-10 -top-6 -left-6 bg-brand-purple rounded-full h-64 w-64 opacity-50 blur-3xl"></div>
